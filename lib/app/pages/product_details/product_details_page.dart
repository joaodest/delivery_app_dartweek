...
import 'package:delivery_app_dartweek/app/core/core/ui/widgets/delivery_inc_dec_button.dart';
...
class ProductDetailsPage extends StatefulWidget {
  ...
  const ProductDetailsPage({Key? key, required this.product, this.order})
      : super(key: key);
...
class _ProductDetailsPageState
    extends BaseState<ProductDetailsPage, ProductDetailController> {
  @override
  void initState() {
    super.initState();
